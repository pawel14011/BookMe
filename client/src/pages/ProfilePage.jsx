...
const ProfilePage = () => {
	...
	const handleSubmit = async e => {
		...
		try {
			console.log('ProfilePage - wysyłam formData:', formData)

			const result = await updateProfile(formData)

			console.log('ProfilePage - otrzymany rezultat:', result)

			setSuccess('Profil zaktualizowany pomyślnie!')
			setIsEditing(false)
		} catch (err) {
			console.error('ProfilePage - błąd:', err)
			setError(err.response?.data?.message || err.message || 'Błąd podczas aktualizacji profilu')
		} finally {
			setLoading(false)
		}
	}
